...
<img src="https://skillicons.dev/icons?i=python,php,laravel,fastapi,react,flutter,postgres,mysql,docker,git,linux,vscode&perline=6" />
</a>
</p>
...
- SQL + unstructured data retrieval  
- Self-correction loops  
- Knowledge-grounded answers

**Impact:** Reduced internal information retrieval time from minutes to seconds.
...
**Impact:** Designed to reduce supervisor planning/admin workload.
